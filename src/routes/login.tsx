    ...
    <div className="mobile-frame flex flex-col bg-background">
      ...
      <form onSubmit={onSubmit} className="flex flex-1 flex-col gap-4 px-7 pt-8">
        ...
        <div className="flex h-14 items-center gap-3 rounded-2xl bg-muted px-4">
          ...
          <input type={show ? "text" : "password"} required value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Password" className="w-full bg-transparent text-sm outline-none" />
        ...
        <div className="mt-auto pb-8 pt-4">
          <PrimaryButton type="submit" disabled={loading}>{loading ? "Signing in..." : "Log In"}</PrimaryButton>
